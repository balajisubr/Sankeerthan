...
public class ThoughtForDayTab extends Fragment {
     ...
     */
public ThoughtForDayTab(){}

public ThoughtForDayTab(String url) {
        super();
        mUrl = url;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mWebView.loadUrl("http://www.radiosai.org/pages/thought.asp");
