...
public class ORaagaLookup implements Runnable {
 
  public ArrayList<String> result;
  public String bhajanName;
  public ORaagaLookup() throws InterruptedException
  {
...
if(t!=null)
  ...
  public static ArrayList<String> lookupRaaga() throws ClientProtocolException,JSONException, IOException, URISyntaxException
  {
	//String bhajans[] = new String[10]; 	  
  HttpClient client = new DefaultHttpClient();
  String URL = AppConfig.URL;
  String url = URL + "/lookup_all/raagas.json";
...
//  HashMap<String,String> bhajanDetails = new HashMap<String,String>();
 String namesListString = namesList.toString();
  ...
  System.out.println("Raaga names ind. are " + list.get(0) + "\n" + list.get(1) + "\n" + list.get(2));  
